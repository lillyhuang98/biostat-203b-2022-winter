...
flabplot=
  labevents_tble %>%
  select("Bicarbonate" : "White Blood Cells") %>%
  count(variables, name = 'number') %>%
  ggplot(aes(x = number, y= `Bicarbonate`, fill = `Bicarbonate`)) +
  geom_boxplot() +
  labs(x = "Bicarbonate measurement", y = "First lab measurement",
       title = "First measurement of Bicarbonate") +
  scale_y_continuous(
...
ggplot(aes(x = response)) +
  ...
  labs(x = "lab measurement item", y = "levels of mesurements")
```
