...
icu_cohort1 <- icu_cohort %>%
  select(-deathtime, -marital_status, -edregtime, -edouttime, -dod, -hadm_death)
...
icu_cohort2 <- icu_cohort1 %>%
  select(anchor_age, creatinine, potassium, sodium, chloride, bicarbonate, hematocrit, white_blood_cell_count, glucose, magnesium, Heart_rate, Non_Invasive_Blood_Pressure_systolic, Non_Invasive_Blood_Pressure_mean, Temperature_Fahrenheit, Respiratory_rate)
